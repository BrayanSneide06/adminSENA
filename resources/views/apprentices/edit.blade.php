...
@section('content')
    <div class="min-h-screen bg-gray-100 flex items-center justify-center px-4 py-8">
        <div
            ...
            <h1 class="text-3xl font-extrabold text-blue-600 mb-6 text-center">Editar Aprendiz</h1>
            ...
            <form action="{{ route('apprentices.update', $apprentice->id) }}" method="POST">
                ...
                <div class="mb-6">
                    <label for="" class="block text-gray-700 font-semibold mb-2">Nombre</label>
                    <input type="text" name="name" id="name" value="{{ old('name',  $apprentice->name) }}"
                ...
                <div class="mb-6">
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email', $apprentice->email) }}"
                        class="w-full border border-blue-300 focus:border-blue-500 focus:ring focus:ring-blue-200 rounded-xl px-4 py-2 shadow-sm transition duration-200">
                </div>


                  <div class="mb-6">
                    <label for="cell_number" class="block text-gray-700 font-semibold mb-2">Email</label>
                    <input type="cell_number" name="cell_number" id="cell_number" value="{{ old('cell_number', $apprentice->cell_number) }}"
                        class="w-full border border-blue-300 focus:border-blue-500 focus:ring focus:ring-blue-200 rounded-xl px-4 py-2 shadow-sm transition duration-200">
                </div>
